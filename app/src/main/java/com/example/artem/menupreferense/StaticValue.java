...
public class StaticValue extends Activity{
    ...
    public static String INFRATED_ILLUMINATION;
    public static String SAVE_POWER;
    ...
    public static String[] VALUE_SENSITIVITY;
    public static String[] VALUE_INFRATED_ILLUMINATION;
    public static String[] VALUE_SAVE_POWER;
    ...
    public static String[] NAME_SENSITIVITY;
    public static String[] NAME_INFRATED_ILLUMINATION;
    public static String[] NAME_SAVE_POWER;
